...
use lamedh::{LispVal, Shared, environment::Environment};
...
fn test_environment_partialeq_two_distinct_envs_not_equal() {
    let env1 = Shared::new(Environment::new());
    let env2 = Shared::new(Environment::new());
...
fn test_environment_partialeq_parent_mismatch() {
    let parent1 = Shared::new(Environment::new());
    let parent2 = Shared::new(Environment::new());
...
fn test_environment_partialeq_dynamic_parent_mismatch() {
    let lex = Shared::new(Environment::new());
    let caller1 = Shared::new(Environment::new());
    let caller2 = Shared::new(Environment::new());
...
fn test_environment_partialeq_none_vs_some_parent() {
    let env_no_parent = Shared::new(Environment::new());
    let parent = Shared::new(Environment::new());
...
fn test_environment_partialeq_one_has_dynamic_parent_other_does_not() {
    ...
    let base = Shared::new(Environment::new());
    let caller = Shared::new(Environment::new());
...
fn test_get_returns_none_for_unbound_in_chain() {
    let grandparent = Shared::new(Environment::new());
